...
def main(args):
    ...
    gender_obj_cap_mw_entries = pickle.load(open(f'{args.data_dir}/Human_Ann/gender_obj_cap_mw_entries.pkl', 'rb')) # Human captions

    #Select captioning model
    if args.cap_model == 'nic':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/Show-Tell/gender_val_st10_cap_mw_entries.pkl', 'rb'))
    elif args.cap_model == 'sat':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/Show-Attend-Tell/gender_val_sat_cap_mw_entries.pkl', 'rb'))
    elif args.cap_model == 'fc':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/Att2in_FC/gender_val_fc_cap_mw_entries.pkl', 'rb'))
    elif args.cap_model == 'att2in':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/Att2in_FC/gender_val_att2in_cap_mw_entries.pkl', 'rb'))
    elif args.cap_model == 'updn':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/UpDn/gender_val_updn_cap_mw_entries.pkl', 'rb'))
    elif args.cap_model == 'transformer':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/Transformer/gender_val_transformer_cap_mw_entries.pkl', 'rb'))
    elif args.cap_model == 'oscar':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/Oscar/gender_val_cider_oscar_cap_mw_entries.pkl', 'rb'))
    elif args.cap_model == 'nic_equalizer':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/Woman-Snowboard/gender_val_snowboard_cap_mw_entries.pkl', 'rb'))
    elif args.cap_model == 'nic_plus':
        selected_cap_gender_entries = pickle.load(open(f'{args.data_dir}/Woman-Snowboard/gender_val_baselineft_cap_mw_entries.pkl', 'rb'))
