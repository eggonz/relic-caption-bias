...
def main(args):
    if os.path.exists(f'{args.data_dir}/race_train.csv'):
        os.remove(f'{args.data_dir}/race_train.csv')
    if os.path.exists(f'{args.data_dir}/race_val.csv'):
        os.remove(f'{args.data_dir}/race_val.csv')
    if os.path.exists(f'{args.data_dir}/race_test.csv'):
        os.remove(f'{args.data_dir}/race_test.csv')
    ...
    race_val_obj_cap_entries = pickle.load(open(f'{args.data_dir}/Human_Ann/race_val_obj_cap_entries.pkl', 'rb')) # Human captions

    #Select captioning model
    if args.cap_model == 'nic':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/Show-Tell/race_val_st10_cap_entries.pkl', 'rb'))
    elif args.cap_model == 'sat':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/Show-Attend-Tell/race_val_sat_cap_entries.pkl', 'rb'))
    elif args.cap_model == 'fc':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/Att2in_FC/race_val_fc_cap_entries.pkl', 'rb'))
    elif args.cap_model == 'att2in':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/Att2in_FC/race_val_att2in_cap_entries.pkl', 'rb'))
    elif args.cap_model == 'updn':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/UpDn/race_val_updn_cap_entries.pkl', 'rb'))
    elif args.cap_model == 'transformer':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/Transformer/race_val_transformer_cap_entries.pkl', 'rb'))
    elif args.cap_model == 'oscar':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/Oscar/race_val_cider_oscar_cap_entries.pkl', 'rb'))
    elif args.cap_model == 'nic_equalizer':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/Woman-Snowboard/race_val_snowboard_cap_entries.pkl', 'rb'))
    elif args.cap_model == 'nic_plus':
        selected_cap_race_entries = pickle.load(open(f'{args.data_dir}/Woman-Snowboard/race_val_baselineft_cap_entries.pkl', 'rb'))
    ...
    if args.calc_ann_leak:
        ...
        if args.task == 'captioning':
            ...
            for cap_ind in range(5):
                with open(f'{args.data_dir}/race_train.csv', 'w') as f:
                ...
                with open(f'{args.data_dir}/race_test.csv', 'w') as f:
                    writer = csv.writer(f, dialect='unix')
                ...
                train_data, test_data = torchtext.legacy.data.TabularDataset.splits(path=f'{args.data_dir}/',train='race_train.csv', test='race_test.csv',
